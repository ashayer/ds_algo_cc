      ...
      <Grid container sx={{ align: "center", alignItems: "center" }}>
        ...
        <Grid item lg={9} md={8} sm={12} xs={6} sx={{ p: 4 }}>
          ...
          <Typography variant="h6" gutterBottom>
            ...
            <HighlightLine lineNum={4} setHoveredLine={setHoveredLine} /> we are creating the front
            and rear pointers to give the array the behavior of the queue and initializing them in
            the class constructor on <HighlightLine lineNum={6} setHoveredLine={setHoveredLine} />.
            These two variables are the only indexes of the array that we have access to satisfy the
            behavior of a queue.
          </Typography>
          <Typography variant="h6" gutterBottom>
            ...
            <HighlightLine lineNum={25} setHoveredLine={setHoveredLine} /> for example, when we try
            to insert an element we check if the queue is empty, if so we can assign that front
            index to that first element at position 0 in the array.
          </Typography>
          <Typography variant="h6">
            For the dequeue implementation{" "}
            <HighlightLine lineNum={29} setHoveredLine={setHoveredLine} /> we can just increment the
            pointer of the front by one. Since it no longer points to that element at the previous
            index, it is essentially deleted.
          </Typography>
        </Grid>
      </Grid>
    </Grid>
