...
const MergeAccordion = ({ tempSectionArray, setTempSectionArray, updateLocalUser }) => {
  ...
  const completed = async (index) => {
    ...
    handleAccordClick(tempSectionArray[2].subsections[index].name);
    handleClose();
  };
