...
import SelectionGeneral from "./SelectionGeneral";
import SelectionCode from "./SelectionCode";

import { questionsArrayForCode, questionsArrayForGeneral } from "./selectionQuiz";
...
const SelectionAccordion = ({ tempSectionArray, setTempSectionArray, updateLocalUser }) => {
  ...
  const completed = async (index) => {
    ...
    handleAccordClick(tempSectionArray[1].subsections[index].name);
    handleClose();
  };
        ...
        <AccordionDetails>
          {tempSectionArray[1].subsections.map((subsection, index) => (
            ...
            >
              ...
              <AccordionDetails>
                {index === 0 ? <SelectionGeneral /> : index === 1 ? <SelectionCode /> : null}
              </AccordionDetails>
              {!subsection.completed ? (
                <Button
                  onClick={() => {
