      ...
      <Grid container sx={{ align: "center", alignItems: "center" }}>
        ...
        <Grid item md={8} xs={12} sx={{ border: "1px solid black" }}>
          <Typography variant="h6">
            ...
            <TextPopover text="NESTED FOR LOOP" id={0} />. The outer loop (line 2) dictates the
            place in the array we are currently starting at for the inner loop. At each iteration
            all values to left of the ith place will be currently sorted where everything to the
            right is untouched. Therefore we need to start at the 2nd element. That is why i=1
            instead of i=0. The inner loop (line 3) will function as a comparison pointer where it
