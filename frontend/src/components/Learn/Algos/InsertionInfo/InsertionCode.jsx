      ...
      <Grid container sx={{ align: "center", alignItems: "center" }}>
        ...
        <Grid item md={8} xs={12} sx={{ border: "1px solid black" }}>
          <Typography variant="h6">
            ...
            to left of the ith place will be currently sorted where everything to the right is
            untouched. Therefore we need to start at the 2nd element. That is why i=1 instead of
            i=0. The inner loop (line 3) will function as a comparison pointer where it will compare
            the current jth element to the jth-1 element, or the one directly to its left. It will
            keep repeating this behavior until two conditions. J reaches the first element of the
            list OR it finds a value that is less than or equal to the current value.
          </Typography>
        </Grid>
      </Grid>
    </Grid>
