                    ...
                    <Grid container>
                        ...
                        <Paper className={classes.paperContent}>
                            <Container maxWidth="xl">
                                        {(questionType === 0) ? <ContentBars/>: 
                                         (questionType === 1) ? <ContentTime/>:
                                         (questionType === 2) ? <ContentSpace/> :
                                         (questionType === 3) ? <ContentCode/> : null
                                        } 
                            </Container>
                        </Paper>
                        <Paper className={classes.paperAnswers}>
                            <Answers answers={answers} createGame={createGame} questionType={questionType}/>
                        </Paper>
                    </Grid>
                </Grow>
